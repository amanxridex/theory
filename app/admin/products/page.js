            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 space-y-1">
                ...
                <div className="text-[10px] text-neutral-500 truncate">
                  Category: {product.product_type || "Homeware"}
                </div>
                <div className="flex items-center gap-2 pt-0.5">
                  ...
                  <span className="text-[10px] text-neutral-500">
                    {product.inventory !== undefined ? `${product.inventory} in stock` : "In stock"}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2 border-t border-[#e5e3dc]">
              ...
              <div className="flex items-center gap-2">
                <Link
                  ...
                  target="_blank"
                  className="px-3 py-1.5 bg-[#f5f2eb] hover:bg-[#eae6dd] text-black rounded text-[11px] font-semibold border border-[#e5e3dc] inline-flex items-center gap-1 transition-colors"
                >
