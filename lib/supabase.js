...
export async function getRealAnalytics() {
  try {
    ...
    const sources = [
      { source: "Direct Studio Visitors", share: Math.round((sourceCounts.Direct / totalSources) * 100) || 60, visitors: sourceCounts.Direct, color: "bg-[#121212]" },
      ...
      { source: "Direct Studio Links", share: Math.round((sourceCounts.Internal / totalSources) * 100) || 5, visitors: sourceCounts.Internal, color: "bg-amber-600" },
    ];
